...
sc_data = read_file('E:/upload_data/simulation/Scenario 3 Replicate 2/sc_data.txt')
st_data = read_file('E:/upload_data/simulation/Scenario 3 Replicate 2/st_data.txt')
