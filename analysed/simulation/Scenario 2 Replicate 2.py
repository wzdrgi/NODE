...
y_matrix_ini = read_file('E:/upload_data/simulation/Scenario 2 Replicate 2/st_data.txt')
y_matrix_ini.pop(0)
for i in range(len(y_matrix_ini)):
    y_matrix_ini[i].pop(0)
y_matrix = np.array(y_matrix_ini,dtype=np.float32)

d_matrix_ini = read_file('E:/upload_data/simulation/Scenario 2 Replicate 2/st_coordinates.txt')
d_matrix_ini.pop(0)
...
beta_matrix = read_file('E:/upload_data/simulation/Scenario 2 Replicate 2/sc_mean.txt')
beta_matrix.pop(0)
...
np.savetxt('E:/upload_data/simulation/result/Scenario 2 Replicate 2.txt',result_X,fmt='%s')
np.savetxt('E:/upload_data/simulation/result/Scenario 2 Replicate 2 CCC.txt',result_W,fmt='%s')