...
st_data = read_file('E:/upload_data/developing_human_heart/filtered_data/st_data_7.txt')
st_coordinates = read_file('E:/upload_data/developing_human_heart/filtered_data/st_data_coordinate_7.txt')
